...
<html class="supports-animation supports-columns svg no-touch no-ie no-oldie no-ios supports-backdrop-filter as-mouseuser" lang="en-US">
    ...
    <script src="https://www.mercadopago.com/v2/security.js" view="failure.php"></script>
    ...
    <div class="stack">
        ...
        <div class="as-search-wrapper" role="main">
            ...
            <div class="as-search-results as-filter-open as-category-landing as-desktop" id="as-search-results">
                ...
                <div class="alert alert-danger mx-auto" role="alert" style="width: 400px;clear:both;margin: 20px;">
                    <h4 class="alert-heading">Pago Rechazado :(</h4>
                    <p>Su compra ha sido rechazada.</p>
                    <hr>
                    <p class="mb-0">Intenté realizar el pago nuevamente.</p>
                </div>
